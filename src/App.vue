...
const navigation = [
  ...
  { name: 'Bible Code', href: '/bible-code', current: false },
  {
  ...
  {
    name: 'Fork This Data on Github Gist',
    href: 'https://gist.github.com/hamar030/3ed4a54ec9f2e8e1721627714193fdcc',
    current: false
  }
]
  ...
  <html>
    <body class="font-body">
      <div class="h-full min-h-screen">
            ...
            <div class="flex h-16 items-center justify-between">
              <div class="flex items-center">
                <div class="flex-shrink-0">
                  <mg class="sr-only h-8 w-8" src="/src/assets/logo.svg" alt="Your Company" />
                  <img
                    width="50"
                    height="50"
        ...
        <header
          class="hidden bg-neutral-100 text-slate-800 shadow-lg dark:bg-slate-800 dark:text-white md:block"
        >
          <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 md:min-h-48 lg:px-8">
            <h1 class="text-3xl font-bold tracking-tight">WeBible</h1>
          </div>
        </header>
        <!-- Content section -->
        <main>

<template>
  <div>
        ...
        <div class="flex h-16 items-center justify-between">
          ...
          <div class="hidden md:block">
            <div class="ml-4 flex items-center md:ml-6">
              <ColorThemeButton class="link-color rounded-full p-1" />
            </div>
          </div>
          <div class="-mr-2 flex md:hidden">
            <ColorThemeButton class="link-color mr-1 rounded-md p-2" />
            <!-- Mobile menu button -->
            <DisclosureButton
    ...
    <header
      class="hidden bg-neutral-100 text-slate-800 shadow-lg md:block dark:bg-slate-800 dark:text-white"
    >
...
const navigation = [
  ...
  { name: 'Bible Code', path: '/biblecode' },
...
.link-color {
  @apply transition-colors delay-150 ease-in-out;
  @apply border border-transparent tracking-wider no-underline underline-offset-4;
  @apply hover:underline;
  /* @apply focus:outline-none focus:ring-2 focus:ring-offset-2; */
  @apply focus:outline-none;
  @apply text-slate-800 hover:text-blue-500 focus:ring-gray-400 focus:ring-offset-gray-50;
  @apply dark:text-slate-400 dark:hover:text-slate-100 dark:focus:ring-gray-600 dark:focus:ring-offset-gray-800;
}
.link-color.router-link-active {
